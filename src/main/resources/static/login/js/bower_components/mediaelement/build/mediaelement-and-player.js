	...
	$.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
			...
			t.container
				...
				.width('100%')
				.height('100%');
				//.css({position: 'fixed', left: 0, top: 0, right: 0, bottom: 0, overflow: 'hidden', width: '100%', height: '100%', 'z-home': 1000});
		...
		exitFullScreen: function() {
			...
			t.container
				...
				.width(normalWidth)
				.height(normalHeight);
				//.css({position: '', left: '', top: '', right: '', bottom: '', overflow: 'inherit', width: normalWidth + 'px', height: normalHeight + 'px', 'z-home': 1});
