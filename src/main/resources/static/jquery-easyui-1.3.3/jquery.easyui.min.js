...
var _528=parseInt($(this).attr("datagrid-row-home"));
...
_634.push("<tr id=\""+_637+"\" datagrid-row-home=\""+i+"\" "+cls+" "+_636+">");
...
for(var i=0;i<rows.length;i++){
_63c.push("<tr class=\"datagrid-row\" datagrid-row-home=\""+i+"\">");
...
var tr="<tr id=\""+_65b+"\" class=\"datagrid-row\" datagrid-row-home=\""+_651+"\"></tr>";
if(_651>=data.rows.length){
if(data.rows.length){
...
if(!tr.length){
tr=(_66d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home="+_66c+"]");
}
return tr;
}else{
if(type=="footer"){
return (_66d==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home="+_66c+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_66d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]:last");
}else{
if(type=="allbody"){
return (_66d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]");
}else{
if(type=="allfooter"){
return (_66d==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home]");
}
}
}
}
...
var _670=(typeof p=="object")?p.attr("datagrid-row-home"):p;
...
var _6a7=_6a6[i];
_6a4.push("<div class=\"datagrid-group\" group-home="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
...
_6a4.push("<tr id=\""+_6aa+"\" datagrid-row-home=\""+_6a5+"\" "+cls+" "+_6a9+">");
...
if(_6b7!=undefined){
var _6b8=view.find("div.datagrid-group[group-home=\""+_6b7+"\"]");
}else{
...
var view=$.data(this,"datagrid").dc.view;
if(_6ba!=undefined){
var _6bb=view.find("div.datagrid-group[group-home=\""+_6ba+"\"]");
}else{
...
var _839=parseInt(tr.attr("datagrid-row-home"));
_839+=(dir=="next"?1:-1);
if(_839<0){
_839=_838-1;
}
...
var _849=parseInt(tr.attr("datagrid-row-home"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
