...
var _20=_1f[i];
_1d.push("<div class=\"datagrid-group\" group-home="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
...
_1d.push("<tr id=\""+_23+"\" datagrid-row-home=\""+_1e+"\" "+cls+" "+_22+">");
...
if(_34!=undefined){
var _36=_35.find("div.datagrid-group[group-home=\""+_34+"\"]");
}else{
...
if(_38!=undefined){
var _3a=_39.find("div.datagrid-group[group-home=\""+_38+"\"]");
}else{
