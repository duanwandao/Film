...
var _d0=parseInt($(this).attr("datagrid-row-home"));
...
_1e4.push("<tr id=\""+_1e7+"\" datagrid-row-home=\""+i+"\" "+cls+" "+_1e6+">");
...
for(var i=0;i<rows.length;i++){
_1ec.push("<tr class=\"datagrid-row\" datagrid-row-home=\""+i+"\">");
...
var tr="<tr id=\""+_20b+"\" class=\"datagrid-row\" datagrid-row-home=\""+_201+"\"></tr>";
if(_201>=data.rows.length){
if(data.rows.length){
...
if(!tr.length){
tr=(_21d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home="+_21c+"]");
}
return tr;
}else{
if(type=="footer"){
return (_21d==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home="+_21c+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_21d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]:last");
}else{
if(type=="allbody"){
return (_21d==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]");
}else{
if(type=="allfooter"){
return (_21d==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home]");
}
}
}
}
...
var _220=(typeof p=="object")?p.attr("datagrid-row-home"):p;
