...
//			var home = opts.editIndex;
//			if (home == undefined){return;}
//			var ed = t.datagrid('getEditors', home)[0];
//			if (ed){
//				ed.target.blur();
//				if (t.datagrid('validateRow', home)){
//					t.datagrid('endEdit', home);
//				} else {
//					t.datagrid('cancelEdit', home);
//				}
//			}
	...
	var groupview = $.extend({}, $.fn.datagrid.defaults.view, {
		render: function(target, container, frozen){
			...
			for(var i=0; i<groups.length; i++){
				...
				table.push('<div class="datagrid-group" group-home=' + i + ' style="height:25px;overflow:hidden;border-bottom:1px solid #ccc;">');
				...
				for(var j=0; j<group.rows.length; j++) {
					...
					table.push('<tr id="' + rowId + '" datagrid-row-home="' + index + '" ' + cls + ' ' + style + '>');
		...
		onAfterRender: function(target){
			...
			view.find('div.datagrid-group').each(function(){
				var groupIndex = $(this).attr('group-home');
	    ...
	    expandGroup:function(jq, groupIndex){
	        return jq.each(function(){
	            ...
	            if (groupIndex!=undefined){
	                var group = view.find('div.datagrid-group[group-home="'+groupIndex+'"]');
	            } else {
